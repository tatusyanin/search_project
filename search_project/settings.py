...
DATABASES = {
    'default': {
        ...
        'PORT': '5432',
        'OPTIONS': {
            'options': '-c search_path=public'  # これを追加
        },
    }
}
...
STATICFILES_DIRS = [
    ...
    '/Users/jo-jaku/Library/Mobile Documents/com~apple~CloudDocs/Desktop/2年次/python演習/search_project/search_project/static',
